...
CONFIG(debug, debug|release) {
    ...
    QMAKE_CFLAGS += -g0 -O3 -msse2 -DNDEBUG -Wl,--exclude-libs,ALL -ffunction-sections -Wl,--gc-sections -fuse-linker-plugin
    QMAKE_CXXFLAGS += -g0 -O3 -msse2 -DNDEBUG -Wl,--exclude-libs,ALL -ffunction-sections -Wl,--gc-sections -fuse-linker-plugin
}
